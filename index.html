...
<body class="antialiased">
    ...
    <div id="app" class="w-full max-w-4xl bg-white p-6 md:p-10 rounded-xl shadow-2xl border-t-8 border-indigo-600">
        ...
        <div id="accuracy-note" class="p-3 mb-6 rounded-lg bg-red-50 border-l-4 border-red-400 text-xs text-red-800">
            **Important Accuracy Note:** This method works best for speeds up to 1/1000s. Accurate measurement at 1/4000s ($\sim$0.25ms) is extremely difficult due to hardware resolution and processing latency. Use a dedicated sensor for high-speed analysis.
        </div>
